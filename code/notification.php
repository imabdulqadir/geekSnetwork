...
if(mysql_num_rows($result)>0)
{
	...
	//echo $fetch['id']."<br/>";
	$sql1=("select comment,userid,msgid from comment where msgposterid='".$_SESSION['user_id']."' and userid!='".$_SESSION['user_id']."' order by c_id desc");
	...
	while($fetch1=mysql_fetch_array($result1))
	{
			...
			$sql2=("Select Fname,Lname from SOCIAL where User_Id='".$fetch1['userid']."'");
